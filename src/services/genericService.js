...
export default class GenericService {
  ...
  /**
   * @description get count of the records that Match a Query
   * @param {Object} criteria
   * @param {Object} projection
   * @param {Object} options
   */
  getRecordsCount(criteria, projection, options, callback) {
    options.lean = true;
    return new Promise((resolve, reject) => {
      MODELS[this.modelName].find(criteria).countDocuments().exec(callback)
    });
  }
