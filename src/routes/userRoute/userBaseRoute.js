  ...
  options: {
    ...
    validate: {
      payload: Joi.object({
        ...
        //The string of administrator is 0, user is 1 and developer is 2
  ...
  options: {
    ...
    handler: function (request, h) {
      ...
      (request.auth &&
        ...
        const payloadData = request.payload;
      return new Promise((resolve, reject) => {
        Controller.UserBaseController.addService(userData, payloadData, function (
          err,
          data
        ) {
          if (err) {
