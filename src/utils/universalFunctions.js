...
// Generate a secret key of length 64
...
// Generate an API key of length 32
...
// Validate a signature given the service name, signature, API key, and secret key
const validateSignature = (serviceName, signature, apiKey, secretKey) => {
  let generatedSignature = generateHmacSignature(apiKey, secretKey, serviceName);
  return generatedSignature == signature;
};

// Define a function to generate the HMAC-SHA256 signature
const generateHmacSignature = (apiKey, secretKey, message) => {
